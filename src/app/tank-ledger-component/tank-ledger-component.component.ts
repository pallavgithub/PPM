...
@Component({
  selector: 'app-tank-ledger-component',
  templateUrl: './tank-ledger-component.component.html',
  styleUrls: ['./tank-ledger-component.component.css']
})
export class TankLedgerComponentComponent implements OnInit {
